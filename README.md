...
- The underlying research predicts 67 soil chemical properties from 22 environmental features across Antarctic ice-free soils. The prediction maps used in this visualization reflects some preliminary results from our Random Forest and XGBoost model outputs. To see updated progress in this research, please review my ansoil-spatial-prediction repository. 

Built With
- D3.js v7 for data-driven visuals
- Scrollama.js for scroll-driven scene transitions
- Vanilla HTML/CSS/JS — no build tools, no dependencies to install
- And some help from Claude AI
